...
description: "A 100-row BOM is 100 claims an auditor can question. How to match it to Scope 3 Category 1 emission factors across fourteen databases — no averaging, no single fabricated number, no lost trail."
