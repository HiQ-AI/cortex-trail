...
- All figures come from the HiQ Cortex PCF technical report v1.0 (2026-06-26), the source of record for every number on this page.
...
Full UUID list (all 14 datasets) is in the technical report v1.0.
