...
For the full walkthrough of how this works in practice, see [BOM matching in Cortex](/solutions/bom-matching). For how Cortex outputs align with ISO 14067, CBAM, and the EF method, see [Standards alignment](/standards).
