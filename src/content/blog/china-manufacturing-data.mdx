...
description: "HiQLCD carries tens of thousands of China-specific LCI records spanning every Chinese provincial grid. Thousands of expert-curated factory term mappings. Why a baseline mismatch in CBAM filings is not a rounding error."
...
| Provincial grid variants | every Chinese province (CN-BJ, CN-SH, CN-GD…) |
